...
//!
//! async fn create_todo(input: input::CreateTodoInput) -> Result<output::CreateTodoOutput, error::CreateTodoError> {
//!     todo!()
//! }
//!
//! async fn delete_todo(input: input::DeleteTodoInput) -> Result<output::DeleteTodoOutput, error::DeleteTodoError> {
//!     todo!()
//! }
//!
...
//! }
//!
//! async fn get_todo(input: input::GetTodoInput) -> Result<output::GetTodoOutput, error::GetTodoError> {
//!     todo!()
//! }
//!
//! async fn list_todos(input: input::ListTodosInput) -> Result<output::ListTodosOutput, error::ListTodosError> {
//!     todo!()
//! }
//!
