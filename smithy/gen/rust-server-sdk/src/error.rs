...
/// Error type for the `UpdateTodoStatus` operation.
/// Each variant represents an error that can occur for the `UpdateTodoStatus` operation.
...
impl ::std::fmt::Display for UpdateTodoStatusError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self {
            UpdateTodoStatusError::NotFoundError(_inner) => _inner.fmt(f),
            UpdateTodoStatusError::ValidationException(_inner) => _inner.fmt(f),
        }
    }
}
impl UpdateTodoStatusError {
    ...
    pub fn is_not_found_error(&self) -> bool {
        matches!(&self, UpdateTodoStatusError::NotFoundError(_))
    }
    /// Returns `true` if the error kind is `UpdateTodoStatusError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(&self, UpdateTodoStatusError::ValidationException(_))
    }
    /// Returns the error name string by matching the correct variant.
    pub fn name(&self) -> &'static str {
        match &self {
            UpdateTodoStatusError::NotFoundError(_inner) => _inner.name(),
            UpdateTodoStatusError::ValidationException(_inner) => _inner.name(),
        }
    }
}
impl ::std::error::Error for UpdateTodoStatusError {
    fn source(&self) -> std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match &self {
            UpdateTodoStatusError::NotFoundError(_inner) => Some(_inner),
            UpdateTodoStatusError::ValidationException(_inner) => Some(_inner),
        }
    }
}
impl ::std::convert::From<crate::error::NotFoundError> for crate::error::UpdateTodoStatusError {
    fn from(variant: crate::error::NotFoundError) -> crate::error::UpdateTodoStatusError {
        Self::NotFoundError(variant)
    }
}
impl ::std::convert::From<crate::error::ValidationException>
    for crate::error::UpdateTodoStatusError
{
    fn from(variant: crate::error::ValidationException) -> crate::error::UpdateTodoStatusError {
