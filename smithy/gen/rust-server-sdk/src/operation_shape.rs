...
impl ::aws_smithy_http_server::operation::OperationShape for UpdateTodoStatus {
    ...
    type Input = crate::input::UpdateTodoStatusInput;
    type Output = crate::output::UpdateTodoStatusOutput;
    type Error = crate::error::UpdateTodoStatusError;
}

impl ::aws_smithy_http_server::instrumentation::sensitivity::Sensitivity for UpdateTodoStatus {
