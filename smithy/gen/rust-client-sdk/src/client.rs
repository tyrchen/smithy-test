...
/// For example, the [`EchoMessage`](crate::operation::echo_message) operation has
/// a [`Client::echo_message`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.echo_message()
///     .message("example")
///     .send()
///     .await;
/// ```
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), echo_client_sdk::Error> {
/// # let client: echo_client_sdk::Client = unimplemented!();
