...
/// Orchestration and serialization glue logic for `EchoMessage`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct EchoMessage;
impl EchoMessage {
    /// Creates a new `EchoMessage`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::echo_message::EchoMessageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::echo_message::EchoMessageOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EchoMessage {
...
/// Error type for the `EchoMessageError` operation.
#[non_exhaustive]
...
impl EchoMessageError {
    ...
    /// Creates the `EchoMessageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `EchoMessageError::ValidationError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for EchoMessageError {
...
pub use crate::operation::echo_message::_echo_message_output::EchoMessageOutput;

pub use crate::operation::echo_message::_echo_message_input::EchoMessageInput;

mod _echo_message_input;

mod _echo_message_output;
