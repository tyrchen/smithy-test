...
/// Orchestration and serialization glue logic for `CreateTodo`.
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_todo::CreateTodoError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_todo::CreateTodoOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTodo {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateTodo");

        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
                CreateTodoRequestSerializer,
            ),
        );
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateTodoResponseDeserializer,
            ),
        );
    ...
    > {
        #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTodo")
...
.with_interceptor(CreateTodoEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_todo::CreateTodoError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_todo::CreateTodoError>::new());
...
#[derive(Debug)]
struct CreateTodoResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CreateTodoResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_todo::de_create_todo_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_todo::de_create_todo_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct CreateTodoRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTodoRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_todo::CreateTodoInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_todo::CreateTodoInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_todo::ser_create_todo_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateTodoEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateTodoEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "CreateTodoEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateTodoInput>()
            .ok_or("failed to downcast to CreateTodoInput")?;
...
/// Error type for the `CreateTodoError` operation.
#[non_exhaustive]
...
pub enum CreateTodoError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateTodoError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateTodoError {
    /// Creates the `CreateTodoError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateTodoError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateTodoError::ValidationError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateTodoError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTodoError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateTodoError {
...
pub use crate::operation::create_todo::_create_todo_output::CreateTodoOutput;

pub use crate::operation::create_todo::_create_todo_input::CreateTodoInput;

mod _create_todo_input;

mod _create_todo_output;
