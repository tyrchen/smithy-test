...
/// Orchestration and serialization glue logic for `GetTodo`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetTodo;
impl GetTodo {
    /// Creates a new `GetTodo`
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::get_todo::GetTodoInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_todo::GetTodoError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_todo::GetTodoOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTodo {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTodo");

        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
                GetTodoRequestSerializer,
            ),
        );
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetTodoResponseDeserializer,
            ),
        );
    ...
    > {
        #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTodo")
...
.with_interceptor(GetTodoEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_todo::GetTodoError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_todo::GetTodoError>::new());
...
#[derive(Debug)]
struct GetTodoResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTodoResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_todo::de_get_todo_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_todo::de_get_todo_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetTodoRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTodoRequestSerializer {
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_todo::GetTodoInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_todo::GetTodoInput,
...
#[derive(Debug)]
struct GetTodoEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetTodoEndpointParamsInterceptor
{
    fn name(&self) -> &'static str {
        "GetTodoEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetTodoInput>()
            .ok_or("failed to downcast to GetTodoInput")?;
...
/// Error type for the `GetTodoError` operation.
#[non_exhaustive]
...
pub enum GetTodoError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTodoError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetTodoError {
    /// Creates the `GetTodoError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetTodoError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetTodoError::ValidationError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetTodoError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTodoError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTodoError {
...
pub use crate::operation::get_todo::_get_todo_output::GetTodoOutput;

pub use crate::operation::get_todo::_get_todo_input::GetTodoInput;

mod _get_todo_input;

mod _get_todo_output;
