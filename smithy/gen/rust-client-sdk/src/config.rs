...
/// Configuration for a echo_client_sdk service client.
///
...
impl Builder {
    ...
    /// use echo_client_sdk::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use echo_client_sdk::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = echo_client_sdk::Config::builder();
    ...
    /// ```no_run
    /// use echo_client_sdk::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// ```no_run
    /// use echo_client_sdk::config::Config;
    /// use echo_client_sdk::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use echo_client_sdk::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use echo_client_sdk::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use echo_client_sdk::config::Config;
    /// use echo_client_sdk::config::timeout::TimeoutConfig;
    ///
    ...
    /// ```no_run
    /// use echo_client_sdk::config::IdentityCache;
    ///
    /// let config = echo_client_sdk::Config::builder()
    ...
    /// ```no_run
    /// use echo_client_sdk::config::BehaviorVersion;
    ///
    /// let config = echo_client_sdk::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("echo_client_sdk::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("echo_client_sdk::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
